...
module hazard_tb;
  ...
  initial begin
    ...
    verify_fwd(5'd5, 5'd0, 5'd5, 5'd5, 5'd5, 1'b1, 1'b1, 1'b1, FWD_MEM1_A, FWD_NONE_B, "Test 10: MEM1 takes priority over MEM2 and WB (rs1E)"); //Testing that fwdA picks MEM1 when rdM1, rdM2, and rdW all match rs1E.
